# Linearize
Construct a linear, no-fork, best version of the CoinLobby blockchain. The scripts
...
JSON-RPC server. Running `coinlobbyd` or `coinlobby-qt -server` will be sufficient.
...
* `input`: coinlobbyd blocks/ directory containing blkNNNNN.dat
