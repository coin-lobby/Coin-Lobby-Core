...
git clone https://github.com/coinlobby/coinlobby
...
```bash
    ...
    From https://github.com/coinlobby/coinlobby
...
[coinlobby/gitian.sigs](https://github.com/coinlobby/gitian.sigs/) repository, or if that's not possible to create a pull
request.
