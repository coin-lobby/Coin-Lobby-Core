...
A full list of comment syntcoinlobbys picked up by doxygen can be found at http://www.stack.nl/~dimitri/doxygen/manual/docblocks.html,
...
CoinLobby Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as CoinLobby Core, where everyone uses
...
pay attention to for reviewers of CoinLobby Core code.

General CoinLobby Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: CoinLobby Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against CoinLobby Core so that they can be integrated
