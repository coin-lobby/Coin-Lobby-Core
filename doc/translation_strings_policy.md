...
This document provides guidelines for internationalization of the CoinLobby Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `coinlobby_en.ts` remains unchanged.
