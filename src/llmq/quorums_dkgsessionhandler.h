// Copyright (c) 2018-2019 The CoinLobby Core developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef CNL_QUORUMS_DKGSESSIONHANDLER_H
#define CNL_QUORUMS_DKGSESSIONHANDLER_H
...
#endif //CNL_QUORUMS_DKGSESSIONHANDLER_H
