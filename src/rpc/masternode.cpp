...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner CoinLobby address\n"
            "  payee          - Print the masternode payout CoinLobby address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting CoinLobby address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "coinlobby",               "masternode",             &masternode,             true,  {} },
    { "coinlobby",               "masternodelist",         &masternodelist,         true,  {} },
    { "coinlobby",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "coinlobby",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
