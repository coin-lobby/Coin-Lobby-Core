...
2. run coinlobbyd with -printalert or -sendalert like this:
   /path/to/coinlobbyd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.coinlobby.com";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/CoinLobby Core:0.12.0.58/"));
