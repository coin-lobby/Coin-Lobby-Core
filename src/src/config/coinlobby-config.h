/* src/config/coinlobby-config.h.  Generated from coinlobby-config.h.in by configure.  */
/* src/config/coinlobby-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The CoinLobby Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "CoinLobby Core"
...
#define PACKAGE_BUGREPORT "https://github.com/coinlobby/coinlobby/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CoinLobby Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CoinLobby Core 1.4.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "coinlobbycore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://coinlobby.com/"
